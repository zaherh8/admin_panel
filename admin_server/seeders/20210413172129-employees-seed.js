...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    // for demo purposes only we are cleaning the db
    // the bulk INsert is not updating the db index for some reason could not find a quick solution
    // TODO try to find a way where the db index gets updated with bulk Insert.
